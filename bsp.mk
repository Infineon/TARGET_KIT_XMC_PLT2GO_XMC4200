...
#
# \brief
# Define the KIT_XMC_PLT2GO_XMC4200 target.
#
################################################################################
# \copyright
...
MPN_LIST:=XMC4200-F64x256
DEVICE:=XMC4200-F64x256
DEVICE_COMPONENTS:=CAT3 XMC42XX
DEVICE_LIST:=XMC4200-F64x256
DEVICE_TOOL_IDS:=bsp-assistant device-configurator library-manager project-creator
DEVICE_XMC4200-F64x256_CORES:=CORE_NAME_CM4_0
DEVICE_XMC4200-F64x256_DIE:=XMC4200
DEVICE_XMC4200-F64x256_FLASH_KB:=256
DEVICE_XMC4200-F64x256_SRAM_KB:=40
